...
import { BannerCard } from "../products/[slug]/features";
import { ProductsCard, SavedCard, TotalCard } from "./features";
      ...
      <main className="w-[calc(100%-10px)] lg:w-[calc(100%-80px)] page-center">
        ...
        <div className="py-5 grid grid-cols-3">
          <div className="flex items-center gap-3">
            ...
            <div className="">
              <p className="text-dark font-normal text-base">Secure payment</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="">
              <p className="text-dark font-normal text-base">Free delivery</p>
              <p className="text-gray-400 font-normal text-base">
                Have you ever finally just{" "}
              </p>
            </div>
